...
import { Settings, Key, Shield, Bell, Building2 } from 'lucide-react'
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-base mt-1">
            Manage your company account preferences and security settings
          </p>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-slate-800 shadow-sm ring-1 ring-slate-900/5 dark:ring-slate-700 rounded-xl p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              Manage your company account security and password settings
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                  Keep your company account secure by using a strong password and enabling security features.
                </p>
              </div>
            </div>
          </div>
